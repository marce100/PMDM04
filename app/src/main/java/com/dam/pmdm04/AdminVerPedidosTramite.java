...
public class AdminVerPedidosTramite extends ToolBarAdmin {
    ...
    private void inicializarDatosPedidos(){
        ...
        pedidos = new ArrayList<Pedido>(bd.pedidoDao().getPedidos("en trámite"));


    }
    private void inicializarRecycleView(){
        if (pedidos.size()>0) {
            recycleAdapter = new RecycleViewAdapter(pedidos, true);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_ver_pedidos_tramite);
